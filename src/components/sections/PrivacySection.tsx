  ...
  return (
    <section className="py-32 px-6 relative overflow-hidden">
      ...
      >
        ...
        <List
          items={[
            "账号注册信息：手机号码、电子邮箱地址、用户名、密码等用于创建和管理您的账号。",
            "个人资料信息：您选择填写的昵称、头像等个人资料。",
        ...
        <Para>
          您的视频和打点数据默认存储在您的设备本地。当您使用云同步功能时，相关数据将加密传输并存储在我们位于中华人民共和国境内的安全服务器上。我们采用行业标准的安全技术和管理措施来保护您的信息，包括但不限于数据加密传输（TLS/SSL）、访问控制和安全审计。
        </Para>
        <Para>
          我们将在实现本政策所述目的所必需的最短时间内保留您的个人信息。当您注销账号后，我们将在合理的时间内删除或匿名化处理您的个人信息，法律法规另有规定的除外。
        </Para>
